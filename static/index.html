...
<div class="page" id="page-top">
    <div class="logo-container"><img src="https://i.ibb.co/CKwJDMmt/Cover.png" alt="Sehha Clinics Logo" class="logo-image"></div>
    ...
    <div class="location-section" id="location-section">
        ...
        <div class="location-grid">
            <div class="location-card">
                ...
                <p class="location-address">6 شــارع الــنــزهــة بــجــوار الـرقـابـة الإداريــة، أرض الــــجـــــولــــف</p>
            </div>
            <div class="location-card">
                <h3>فرع المعادي</h3>
                <div class="location-map">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allClinicsFullData = [
        { id: "الباطنة-والجهاز-الهضمي-والكبد", doctors: [ { name: "د. عبد الرحيم الطيب (اخصائي)", en_name: "Dr. Abdelrahim Eltayeb", schedule: { "الأحد": "02:00 PM", "الأربعاء": "02:00 PM" } } ] },
        { id: "مسالك", doctors: [ { name: "د. احمد شفیع (استشاري)", en_name: "Dr. Ahmed Shafie", schedule: { "الأحد": "06:00 PM", "الأربعاء": "06:00 PM" } } ] },
        { id: "باطنة-عامة", doctors: [ { name: "د. ندين (اخصائي)", en_name: "Dr. Nadine", schedule: { "السبت": "10:00 AM", "الإثنين": "10:00 AM" } }, { name: "د. هاله (اخصائي)", en_name: "Dr. Hala", schedule: { "الثلاثاء": "10:00 AM" } }, { name: "د. انجى يسرى (اخصائي)", en_name: "Dr. Engy Yousry", schedule: { "الأحد": "10:00 AM", "الأربعاء": "10:00 AM", "الخميس": "10:00 AM" } } ] },
        { id: "غدد-صماء-وسكر", doctors: [ { name: "د. احمد سامی (استشاري)", en_name: "Dr. Ahmed Samy", schedule: { "السبت": "08:00 PM", "الثلاثاء": "08:00 PM" } } ] },
        { id: "القلب-والإيكو", doctors: [ { name: "د. محمود سعید (اخصائي)", en_name: "Dr. Mahmoud Saeed", schedule: { "السبت": "10:00 AM" } }, { name: "د. وسيم (اخصائي)", en_name: "Dr. Waseem", schedule: { "الإثنين": "10:00 AM" } }, { name: "د. محمد نبيل (استشاري)", en_name: "Dr. Mohamed Nabil", schedule: { "الإثنين": "07:00 PM", "الخميس": "07:00 PM" } }, { name: "د. غاده عادل (استشاري)", en_name: "Dr. Ghada Adel", schedule: { "الثلاثاء": "10:00 AM", "الأربعاء": "10:00 AM", "الخميس": "10:00 AM" } } ] },
        { id: "السونار-والدوبلكس", doctors: [ { name: "د. أحمد عثمان (اخصائي)", en_name: "Dr. Ahmed Othman", schedule: { "الأحد": "03:00 PM", "الأربعاء": "03:00 PM" } }, { name: "د. مصطفی عثمان (اخصائي)", en_name: "Dr. Mostafa Othman", schedule: { "الإثنين": "03:00 PM" } }, { name: "د. كريم فاروق (اخصائي)", en_name: "Dr. Karim Farouk", schedule: { "الثلاثاء": "03:00 PM", "الخميس": "03:00 PM" } } ] },
        { id: "جراحة-التجميل", doctors: [ { name: "د. يحيى خالد (اخصائي)", en_name: "Dr. Yehia Khaled", schedule: { "الإثنين": "09:00 PM", "الأربعاء": "09:00 PM" } }, { name: "د. إسلام مصطفی (اخصائي)", en_name: "Dr. Islam Mostafa", schedule: { "الثلاثاء": "03:00 PM" } } ] },
        { id: "عظام", doctors: [ { name: "د. هديل العجيلي (استشاري)", en_name: "Dr. Hadeel Al-Ajili", schedule: { "الثلاثاء": "07:00 PM", "الخميس": "07:00 PM" } }, { name: "د. محمد صلاح (استشاري)", en_name: "Dr. Mohamed Salah", schedule: { "الأربعاء": "09:00 PM" } } ] },
        { id: "جلدية-وليزر", doctors: [ { name: "د. دينا امیر (استشاري)", en_name: "Dr. Dina Amir", schedule: { "السبت": "10:00 AM", "الإثنين": "10:00 AM", "الأربعاء": "10:00 AM" } }, { name: "د. ياسمين احمد (اخصائي)", en_name: "Dr. Yasmine Ahmed", schedule: { "الخميس": "06:00 PM" } } ] }
    ];

    // =================================================================================
    // START: NEW PROFESSIONAL ICONS (FONT AWESOME)
    // =================================================================================
    const clinicsDisplayData = [
        { id: "الباطنة-والجهاز-الهضمي-والكبد", name: "الباطنة والجهاز الهضمي والكبد", en_name: "Gastroenterology & Hepatology", icon: "fa-notes-medical", isSvg: false },
        { id: "مسالك", name: "المسالك البولية", en_name: "Urology", icon: "fa-toilet", isSvg: false },
        { id: "باطنة-عامة", name: "الباطنة العامة", en_name: "General Medicine", icon: "fa-stethoscope", isSvg: false },
        { id: "غدد-صماء-وسكر", name: "غدد صماء وسكر", en_name: "Endocrinology & Diabetes", icon: "fa-person-dots-from-line", isSvg: false },
        { id: "القلب-والإيكو", name: "القلب والإيكو", en_name: "Cardiology & Echocardiography", icon: "fa-heart-pulse", isSvg: false },
        { id: "السونار-والدوبلكس", name: "السونار والدوبلكس", en_name: "Ultrasound & Doppler", icon: "fa-wave-square", isSvg: false },
        { id: "جراحة-التجميل", name: "جراحة التجميل", en_name: "Plastic Surgery", icon: "fa-wand-magic-sparkles", isSvg: false },
        { id: "عظام", name: "العظام", en_name: "Orthopedics", icon: "fa-bone", isSvg: false },
        { id: "جلدية-وليزر", name: "الجلدية والليزر", en_name: "Dermatology & Laser", icon: "fa-spa", isSvg: false }
    ].map(clinic => {
        const fullData = allClinicsFullData.find(c => c.id === clinic.id);
        return { ...clinic, doctors: fullData ? fullData.doctors : [] };
    });
    // =================================================================================
    // END: DOCTOR AND CLINIC DATA
    // =================================================================================
    ...
    function displayFallback(message = null) {
        ...
        const clinicInfo = clinicMap.get("باطنة-عامة");
        ...
        recommendationResultContainer.innerHTML = `
            <div class="recommendation-card primary-recommendation">
                ...
                <button class="go-to-btn" onclick="scrollToClinic('باطنة-عامة')">اذهب إلى عيادة الباطنة العامة <i class="fa-solid fa-arrow-down"></i></button>
            </div>
        `;
    }
    ...
    function handleFiles(files) {
        [...files].forEach(file => {
            if (file.size > 5 * 1024 * 1024) { alert(`الملف "${file.name}" كبير جدًا (أكثر من 5 ميجابايت) ولن يتم رفعه.`); return; }
            const reader = new FileReader();
            reader.onload = (e) => {
                uploadedFiles.push({ name: file.name, base64: e.target.result, mimeType: file.type || 'application/octet-stream' });
                renderPreviews();
            };
    ...
    function renderPreviews() {
        ...
        uploadedFiles.forEach((fileData, index) => {
            ...
            if (fileData.mimeType.startsWith('image/')) {
                filePreviewHtml = `<img src="${fileData.base64}" alt="${fileData.name}">`;
            } else {
                let iconClass = fileData.mimeType.includes('pdf') ? 'fa-solid fa-file-pdf' : 'fa-solid fa-file';
                filePreviewHtml = `<div class="file-icon"><i class="${iconClass}"></i><span>${fileData.name}</span></div>`;
            }
            previewItem.innerHTML = `${filePreviewHtml}<button class="remove-file-btn" data-index="${index}">&times;</button>`;
    ...
    function updateAnalyzeButtonState() { analyzeBtn.disabled = uploadedFiles.length === 0; }
    ...
    analyzeBtn.addEventListener('click', async () => {
        ...
        const filesPayload = uploadedFiles.map(file => ({ mime_type: file.mimeType, data: file.base64.split(',')[1] }));
        try {
            const response = await fetch(ANALYZE_API, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ files: filesPayload, notes: userNotesInput.value })
            });
            if (!response.ok) {
            ...
            analysisResultContainer.innerHTML = `<div class="analysis-card"><p style="color:var(--danger-red);">عفواً، حدث خطأ تقني: ${error.message}. يرجى التأكد من أن الملفات واضحة والمحاولة مرة أخرى.</p></div>`;
        } finally {
        ...
        if (data.recommendations && data.recommendations.length > 0 && data.recommendations[0].id) {
            ...
            if (clinicInfo) {
                ...
                recommendationsHtml = `
                    ...
                    <button class="go-to-btn" style="margin-top: 15px;" onclick="scrollToClinic('${rec.id}')">اذهب إلى عيادة ${clinicInfo.name} <i class="fa-solid fa-arrow-down"></i></button>
                `;
            }
        }
        card.innerHTML = `
            <div class="disclaimer"><i class="fa-solid fa-triangle-exclamation"></i> <strong>تنبيه هام:</strong> هذا التحليل هو مجرد إرشاد أولي ولا يغني إطلاقًا عن استشارة الطبيب المختص.</div>
            <h3 class="analysis-section-title">شرح احترافي مبدئي للتقرير</h3>
            <p>${data.interpretation || 'لم يتمكن المساعد من تقديم شرح واضح.'}</p>
            <h3 class="analysis-section-title">نصائح وإرشادات مؤقتة</h3>
            <ul>${(data.temporary_advice && data.temporary_advice.length > 0) ? data.temporary_advice.map(item => `<li>${item}</li>`).join('') : '<li>لا توجد نصائح محددة.</li>'}</ul>
            ${recommendationsHtml}
        `;
